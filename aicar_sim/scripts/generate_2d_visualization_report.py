...
from aicar_sim.visualization_2d import build_2d_visualization_report  # noqa: E402
...
DEFAULT_OUTPUT_PATH = (
    PROJECT_ROOT / "outputs" / "visualization_2d" / "stage3_2d_visual_report.html"
)
STAGE2_OUTPUTS = {
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Generate Stage3.1 2D visualization HTML.")
    parser.add_argument(
        "--vehicle-type-result",
    ...
    parser.add_argument(
        ...
        help="Output path for stage3_2d_visual_report.html.",
    )
    return parser
...
def main() -> None:
    ...
    html_text, summary = build_2d_visualization_report(
