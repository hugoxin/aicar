...
`showcase_apps\stage4_3d_path_viewer` 是从 Stage4.5 冻结 `main` 创建的独立 Three.js 展示应用。V1.0.2 通过 Python 把冻结的 Stage4.5-R 路径导出为 `viewer_scene.json`，并以统一活动段、路径角色和展示上下文同步扫描点、高亮、侧栏与执行说明，明确区分正式扫描、辅助移动和状态切换。
