...
REQUIRED_PATHS = [
    ...
    DEMO_ROOT / "scripts" / "run_stage3_customer_showcase_demo.py",
    DEMO_ROOT / "templates" / "stage3_customer_showcase_report_template.html",
    AICAR_ROOT / "aicar_sim" / "scripts" / "generate_customer_showcase_report.py",
]
VEHICLE_TYPE_RESULT = (
...
def main() -> None:
    ...
    if missing:
        print("Missing Stage3 customer showcase demo paths:")
        for path in missing:
            print(f"- {path}")
        raise SystemExit(1)
    ...
    print("AI car stage3 customer showcase demo check OK")
