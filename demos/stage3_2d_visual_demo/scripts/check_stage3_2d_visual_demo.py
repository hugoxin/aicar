...
REQUIRED_PATHS = [
    ...
    DEMO_ROOT / "scripts" / "run_stage3_2d_visual_demo.py",
    DEMO_ROOT / "templates" / "stage3_2d_visual_report_template.html",
    AICAR_ROOT / "aicar_sim" / "scripts" / "generate_2d_visualization_report.py",
]
VEHICLE_TYPE_RESULT = (
...
def main() -> None:
    ...
    if missing:
        print("Missing Stage3 2D visual demo paths:")
        for path in missing:
            print(f"- {path}")
        raise SystemExit(1)
    ...
    print("AI car stage3 2D visual demo check OK")
